...
class RealWorldTask2_stackcube(tfds.core.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.local_traj_data_path = '/projects/vidlab_data/data/xArm7_RealWorldTrajectories/task2_stack-blue-on-green-cube' # base path to trajectories
        self.glob_str = '/projects/vidlab_data/data/xArm7_RealWorldTrajectories/task2_stack-blue-on-green-cube/**/*.hdf5' # glob string that will return all of the .hdf5 files. Test this with `glob.glob(glob_str, recursive=True)`
        ...
        def _parse_example(episode_path):
            with h5py.File(episode_path, 'r') as f:
                ...
                for imkey in image_keys:
                    image_paths[imkey] = [
                        path.decode('utf-8').replace('/workspace/xarm-dataset/stack_blue_cube_on_top_of_green_cube', self.local_traj_data_path)
                        for path in f[imkey][:]
                    ]
            ...
            for i in range(episode_len-1):
                ...
                episode.append({
                    ...
                    'language_instruction': 'Stack the blue cube on the green cube'
                })
    ...
    def sample_trajectories(self, episode_paths):
        ...
        return episode_paths[:self.clamp_num_trajectories]